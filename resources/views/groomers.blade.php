...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Groomers</div>
                    <div class="card-body">
                        <a href="{{ route('services.addgroomer') }}" class="btn btn-success btn-sm" title="Add New Breeder">
                            ...
                            @foreach ($groomers as $g)
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Photo</th>
                                        <td>
                                            <img src="/public/images/{{ $g->photo }}" id="slik" alt="puppy image" width='100'
